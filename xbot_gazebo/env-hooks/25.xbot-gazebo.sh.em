...
: ${XBOT_GAZEBO_MAP_FILE:=`rospack find xbot_gazebo`/maps/playground.yaml}
: ${XBOT_GAZEBO_WORLD_FILE:=`rospack find xbot_gazebo`/worlds/playground.world}

# Exports
export XBOT_GAZEBO_MAP_FILE
export XBOT_GAZEBO_WORLD_FILE
