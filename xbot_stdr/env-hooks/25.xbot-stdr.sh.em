# Set some sane defaults for the xbot stdr launch environment
##Documentation:
...
: ${XBOT_STDR_MAP_FILE:=`rospack find xbot_stdr`/maps/sparse_obstacles.yaml}
# Exports
export XBOT_STDR_MAP_FILE
